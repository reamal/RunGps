...
import com.bravo.rungps.receiver.WakeUpReceiver;
...
public class WorkService extends Service {
    ...
    int onStart(Intent intent, int flags, int startId) {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.N) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) startService(new Intent(App.getInstance(), WorkNotificationService.class));
        }
    ...
    static void startService() {
        ...
        sSubscription = Observable
                ...
                .doOnDispose(() -> {
                    ...
                    App.getInstance().sendBroadcast(new Intent(WakeUpReceiver.ACTION_CANCEL_JOB_ALARM_SUB));
                }).subscribe(count -> {
